...
function useRadioGroup(params) {
  ...
  const getRootProps = React.useCallback((externalProps = {}) => (0, _mergeReactProps.mergeReactProps)(fieldControlValidation.getValidationProps(externalProps), {
    role: 'radiogroup',
  ...
  }), [fieldControlValidation, disabled, readOnly, labelId, setFocused, setFieldTouched, validationMode, checkedValue]);
  ...
  const getInputProps = React.useCallback((externalProps = {}) => (0, _mergeReactProps.mergeReactProps)(fieldControlValidation.getInputValidationProps(externalProps), {
    type: 'hidden',
