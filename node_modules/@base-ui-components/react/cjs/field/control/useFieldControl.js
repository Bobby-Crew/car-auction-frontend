...
function useFieldControl(params) {
  ...
  const getControlProps = React.useCallback((externalProps = {}) => (0, _mergeReactProps.mergeReactProps)(getValidationProps(getInputValidationProps(externalProps)), {
    id,
    disabled,
    name,
    ref: inputRef,
  ...
  }), [getValidationProps, getInputValidationProps, id, disabled, name, inputRef, labelId, value, setDirty, validityData.initialValue, setFilled, errors, setValue, onClearErrors, setFocused, setTouched, validationMode, commitValidation]);
