...
function useMenuRoot(parameters) {
  ...
  (0, _useScrollLock.useScrollLock)(open && modal, triggerElement);
  ...
  const floatingRootContext = (0, _react2.useFloatingRootContext)({
    ...
    onOpenChange(openValue, eventValue, reasonValue) {
      ...
      if (isHover) {
        ...
        }, _constants.PATIENT_CLICK_THRESHOLD);
  ...
  return React.useMemo(() => ({
    ...
    onOpenChangeComplete,
    setHoverEnabled
  }), [activeIndex, floatingRootContext, getItemProps, getPopupProps, getTriggerProps, itemDomElements, itemLabels, mounted, open, positionerRef, setOpen, transitionStatus, setPositionerElement, openReason, instantType, onOpenChangeComplete]);
}