 ...
 */
const ProgressValue = exports.ProgressValue = /*#__PURE__*/React.forwardRef(function ProgressValue(props, forwardedRef) {
  const {
    className,
    render,
    children,
  ...
  const getValueProps = React.useCallback((externalProps = {}) => {
