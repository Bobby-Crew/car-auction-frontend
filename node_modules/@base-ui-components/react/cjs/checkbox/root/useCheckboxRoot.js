...
exports.UseCheckboxRoot = void 0;
...
function useCheckboxRoot(params) {
  ...
  const getButtonProps = React.useCallback((externalProps = {}) => (0, _mergeReactProps.mergeReactProps)(getValidationProps(externalProps), {
    id,
    ref: buttonRef,
    type: 'button',
    role: 'checkbox',
  ...
  }), [getValidationProps, id, disabled, indeterminate, checked, readOnly, labelId, setFocused, setTouched, validationMode, commitValidation, groupContext, groupValue]);
  ...
  }), [getInputValidationProps, checked, disabled, name, value, required, autoFocus, mergedInputRef, groupContext, setDirty, validityData.initialValue, setCheckedState, onCheckedChange, validationMode, groupValue, setGroupValue, commitValidation, setFilled]);
...
let UseCheckboxRoot = exports.UseCheckboxRoot = void 0;